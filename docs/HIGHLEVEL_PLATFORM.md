...
**Action item:** once created, manually seed it — ~20 contacts with real-looking names/emails/phones/tags, a calendar, and 5–10 appointments spread over the coming days. Your Loom demo lives or dies on this. Write it as a seed script (`scripts/seed-sandbox.mjs`) — as built it creates 20 contacts and 8 appointments, two per business day at 10:00 and 15:00 UTC — using the API so you can re-run it; that's also a nice thing to point at in the README.
